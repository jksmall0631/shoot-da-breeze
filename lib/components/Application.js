  ...
  render() {
    ...
    return (
      <section className="Application">
        ...
        <button onClick={()=>{this.setState({reverse: true})}}>reverse</button>
        <LoginLogout signInOut={signOut} setUser= {(userName) => this.setState({ user: null })} text='logout'/>
        <DisplayConversation messages={this.state.messages} userMessages={this.state.userMessages} reverse={this.state.reverse}/>
